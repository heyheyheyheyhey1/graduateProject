...
def add_cnn_layer ():
    ...
    fout = drop_out(flatw_plus_b,0.75)
...
train_x,test_x,train_y,test_y = train_test_split(imgs,labels,test_size=0.2, random_state=random.randint(0,100))
